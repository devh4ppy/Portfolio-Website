...
const index = () => {
  ...
  return (
    <div className="flex flex-col px-6 pt-1 flex-grow">
      ...
      <h5 className="my-3 font-medium">I'm a backend developer with a passion for creating efficient, reliable, and secure web applications. I specialize in developing REST APIs, database systems, and server-side scripting. I have a deep understanding of software engineering principles, algorithms, and design patterns, and I'm always learning new technologies to stay ahead of the curve.
      </h5>
