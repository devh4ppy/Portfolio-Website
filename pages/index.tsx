...
const index = () => {
  ...
  return (
    <div className="flex flex-col px-6 pt-1 flex-grow">
      ...
      <h5 className="my-3 font-medium">Recent College graduate with background of web development.
          Excellent focus, communication, ability to learn rapidly.
          excels working in a team environment.
          Strong critical analysis and problem solving.
      </h5>
